...
public class Snake extends JPanel implements Runnable {
    ...
    public Snake(Integer width, Integer height) {
        ...
        largerFont = getFont().deriveFont(Font.BOLD, 28);
        initGrid();
    ...
    void drawStartScreen(Graphics2D g) {
        ...
        g.drawString("Snake (Chat Channels easter egg)", 100, 190);
        g.setColor(Color.white);
        g.setFont(smallFont);
    ...
    public static void main(String[] args) {
        ...
        int result = JOptionPane.showConfirmDialog(f,
                "Please put this plugin inside of your plugins folder.\nChat Channels is not meant to be run separately.",
                "Chat Channels",
        ...
        if (result == JOptionPane.CANCEL_OPTION) {
            ...
            SwingUtilities.invokeLater(
                    () -> {
                        ...
                        mainFrame.setTitle("Chat Channels - Snake Easter Egg");
                        mainFrame.setResizable(false);
                        mainFrame.add(new Snake(640, 440), BorderLayout.CENTER);
                        mainFrame.pack();
